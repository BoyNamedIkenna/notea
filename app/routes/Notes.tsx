      ...
      <div className="w-screen bg-amber-700 flex">
        {isMobile ? (
          <>
            ...
            {/* Sidebar drawer */}
            <div
              className={`fixed top-0 left-0 z-50 h-full w-64 bg-white border-r border-gray-200 shadow transition-transform duration-300 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
                }`}
            >
